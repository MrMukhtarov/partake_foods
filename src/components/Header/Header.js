        ...
        <div className="container">
            <div className="row justify-content-between align-items-center">
                ...
                <div className="right col-lg-3 align-items-center text-end">
                    ...
                    <i onClick={searchIcon} className="fa-solid fa-magnifying-glass ml-4" title='search'></i>
                    ...
                    <div className="searchContainer">
                        <div className="all">
                           ...
                           <div className="left col-lg-5">
                            ...
                            <div className="right col-lg-1">
                            <i onClick={exitIcon} class="fa-solid fa-xmark" title='close'></i>
                            </div>
                           </div>
